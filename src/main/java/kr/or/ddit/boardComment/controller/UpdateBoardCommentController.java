...
/**
 * Servlet implementation class UpdateBoardCommentController
 */
@WebServlet("/updateComment")
public class UpdateBoardCommentController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(UpdateBoardCommentController.class);  
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		BoardCommentVO boardCommentVO = new BoardCommentVO(commId, writeId, content);
