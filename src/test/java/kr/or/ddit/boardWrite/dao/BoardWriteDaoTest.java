...
public class BoardWriteDaoTest {
	...
	public void boardWriteListTest() {
		...
		/***When***/
		List<BoardWriteVO> boardWriteList = boardWriteDao.boardWriteList(pageVO);
	...
	public void getBoardWriteTest() {
		...
		BoardWriteVO getBoardWrite = boardWriteDao.getBoardWrite(boardWriteVO);
	...
	public void deleteBoardWriteTest() throws ParseException{
		...
		/***When***/
		int deleteCnt = boardWriteDao.deleteBoardWrite(boardWriteVO);
